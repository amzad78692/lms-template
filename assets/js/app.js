...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('popularCourses', () => ({
    ...
    courses: [
      { id: 1, category: 'Development', catKey: 'development', catColor: '#0d6efd', badge: 'Bestseller', badgeColor: '#fbbf24', thumb: 'https://placehold.co/400x220/0d1b4b/60a5fa?text=JavaScript+%26+React',      title: 'Complete JavaScript & React Developer Bootcamp 2026',                    instructor: 'David Miller', instructorAvatar: 'https://placehold.co/20x20/0d6efd/fff?text=D', rating: '4.9', reviews: '3,241', lessons: 82, duration: '36h 20m', level: 'Beginner',    students: '12,450', price: '$49', originalPrice: '$199' },
      { id: 2, category: 'Design',      catKey: 'design',      catColor: '#7c3aed', badge: 'New',        badgeColor: '#10b981', thumb: 'https://placehold.co/400x220/1e1b4b/a78bfa?text=UI%2FUX+Design',          title: 'UI/UX Design Mastery — Figma, Prototyping & Design Systems',             instructor: 'Sarah Chen',   instructorAvatar: 'https://placehold.co/20x20/7c3aed/fff?text=S', rating: '4.8', reviews: '1,876', lessons: 64, duration: '28h 45m', level: 'Intermediate', students: '8,120',  price: '$59', originalPrice: '$249' },
      { id: 3, category: 'Business',    catKey: 'business',    catColor: '#d97706', badge: 'Bestseller', badgeColor: '#fbbf24', thumb: 'https://placehold.co/400x220/1c1a0f/fbbf24?text=Business+Strategy',      title: 'Business Strategy & Entrepreneurship: From Idea to Launch',              instructor: 'James Wilson', instructorAvatar: 'https://placehold.co/20x20/d97706/fff?text=J', rating: '4.7', reviews: '2,109', lessons: 48, duration: '22h 10m', level: 'All Levels', students: '9,340',  price: '$44', originalPrice: '$179' },
      { id: 4, category: 'Development', catKey: 'development', catColor: '#0d6efd', badge: 'Hot',        badgeColor: '#ef4444', thumb: 'https://placehold.co/400x220/0c0a1a/818cf8?text=Python+%26+ML',          title: 'Python for Data Science & Machine Learning — Complete Course',           instructor: 'Priya Sharma', instructorAvatar: 'https://placehold.co/20x20/4f46e5/fff?text=P', rating: '4.9', reviews: '4,532', lessons: 96, duration: '48h 00m', level: 'Beginner',    students: '18,200', price: '$69', originalPrice: '$299' },
      { id: 5, category: 'Marketing',   catKey: 'marketing',   catColor: '#db2777', badge: 'Trending',   badgeColor: '#06b6d4', thumb: 'https://placehold.co/400x220/0c1a1a/67e8f9?text=Digital+Marketing',     title: 'Digital Marketing Mastery: SEO, Social Media & Paid Ads',                instructor: 'Emma Roberts', instructorAvatar: 'https://placehold.co/20x20/db2777/fff?text=E', rating: '4.7', reviews: '1,654', lessons: 55, duration: '26h 30m', level: 'Beginner',    students: '7,890',  price: '$39', originalPrice: '$149' },
      { id: 6, category: 'Design',      catKey: 'design',      catColor: '#7c3aed', badge: '',           badgeColor: '',        thumb: 'https://placehold.co/400x220/1a0a2e/c4b5fd?text=Motion+Design',         title: 'Motion Design & Animation with After Effects — Pro Level',               instructor: 'Leo Tanaka',   instructorAvatar: 'https://placehold.co/20x20/7c3aed/fff?text=L', rating: '4.8', reviews: '987',   lessons: 70, duration: '32h 15m', level: 'Advanced',    students: '4,210',  price: '$79', originalPrice: '$319' },
    ],
